...
// WhereTheShadowLies
#define COCOAPODS_POD_AVAILABLE_WhereTheShadowLies
#define COCOAPODS_VERSION_MAJOR_WhereTheShadowLies 0
#define COCOAPODS_VERSION_MINOR_WhereTheShadowLies 1
#define COCOAPODS_VERSION_PATCH_WhereTheShadowLies 0
